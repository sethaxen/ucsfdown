...
If you'd like to see examples of other things in this template, please [contact us](https://github.com/sethaxen/ucsfdown/issues/new) (email <seth.axen@gmail.com>) with your suggestions. We love to see people using _R Markdown_ for their theses, so we'll do our best to help. 
