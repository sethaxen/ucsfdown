...
\report{$report$} 
  ...
  \campus{$uccampus$}
	...
	% \maketitle % as of 2020 Summer, the title page is counted but not included, instead handled by docusign
	
	% APPROVAL AND COPYRIGHT
	% \approvalpage % AS OF 2020 Summer, don't need an approval page
	\copyrightpage
