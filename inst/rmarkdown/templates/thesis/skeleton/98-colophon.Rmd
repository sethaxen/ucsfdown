...
It was written in R Markdown and $\LaTeX$, and rendered into PDF using [ucsfdown](https://github.com/sethaxen/ucsfdown) and [bookdown](https://github.com/rstudio/bookdown). 
